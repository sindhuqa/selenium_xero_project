...
public class AutomationScriptsTestNG extends ReusableModules {

	@BeforeSuite
	public static void startTestSuite()
	{
		report = new ExtentReports("ExtentReportResults.html"); //path
		test = report.startTest("Selenium Hackathon Report");
	}
	
	@BeforeTest
	public static void readData()
	{
		String[][] credentials = readExcelSheetData("TestLoginData.xlsx", "Sheet1");
	}
	...
	public static void TestID05() throws InterruptedException 
	{
		...
		EnterText(email, "user@yahoo.com", "emailaddress");
	...
	public static void TestID06() throws InterruptedException 
	{
		...
		WebElement email = driver.findElement(By.xpath("//input[@name='EmailAddress']"));
		EnterText(email, "invaliduseryahoo@.com", "emailaddress");
...
//		Account1.selectByVisibleText("Sales");
	...
	public static void TestID12() throws InterruptedException
	{
		...
		EnterText(browse_btn,"butterfly.jpg", "Image"); //path of the image present
